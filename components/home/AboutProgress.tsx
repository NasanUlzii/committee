...
const AboutProgress = () => {
    const data = [
        { id: 1, title: 'Digital Marketing', percent: 95, icon: <FaBullseye className='text-white text-3xl' /> },
        { id: 2, title: 'Digital Business', percent: 85, icon: <HiOutlineChartBar className='text-white text-3xl' /> },
    ]
                ...
                <div key={item.id}
                    ...
                    <div className='flex-1'>
                        ...
                        <div className='w-full h-2 bg-gray-300 rounded-full overflow-hidden'>
                            <div className='h-2 bg-[#b58b58] rounded-full'
