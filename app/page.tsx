  ...
  return (
    <div>
      ...
      <div className="md:flex md:flex-row-reverse py-4">
        ...
        <div className="">
          <div className="font-quicksand text-3xl md:text-4xl font-thin tracking-wide text-foreground mb-4">
            The benefits of live-in care
          </div>
          <div className="font-quicksand text-sm md:text-sm font-thin tracking-wide text-foreground/60">
            Why 9 out of 10 elderly people would prefer to be cared for in their
            own home.
          </div>
      ...
      <div className="bg-neutral-800">
        ...
        <div className="p-2">
          All carers on Elder pass a rigorous screening which includes a
          background check, character and skills assessment, and verifiable
          professional references. Only 2% of applicants are successful. As a
          result, 9 out of 10 customers are very satisfied with their first
          carer.
        </div>
      </div>
      <div className="p-8">
