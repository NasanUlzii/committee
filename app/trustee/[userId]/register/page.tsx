...
import {
  TrusteeExtendedValidationType,
  TrusteeFormValidationType,
} from "@/lib/validation";
...
const TrusteeRegister = () => {
  ...
  const [user, setUser] = useState<
    Awaited<ReturnType<typeof getTrustee>> | undefined
  >();
  useEffect(() => {
    ...
    <>
      <div className="hero">
        <div className="w-full px-[8%] lg:px-[12%] py-10">
          <div className="text-2xl font-bold mb-8 mt-10">
            Registered user {user?.lastName} {user?.firstName}
            Утас: {user?.phone}
          </div>
