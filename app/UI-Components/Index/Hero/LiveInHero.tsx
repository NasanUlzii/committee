...
const PricingPlansData = [
  {
    id: "1",
    plan: "60+ ажилчид",
    desc: "Select from over 6,000 qualified carers.",
  },
  {
    id: "2",
    plan: "Шуурхай",
    desc: "Care can begin in as little as 24 hours.",
  },
  {
    id: "3",
    plan: "Хот, эргэн тойронд",
    desc: "We have organised care in every GB postcode.",
  },
  {
    id: "4",
    plan: "Хэмнэлттэй",
    desc: "Costs on average 35% less than traditional services.",
  },
];
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="">
              ...
              <h1 className="text-6xl lg:text-6xl CalSans my-5">
                Live-in care tailored to{" "}
                <span className="text-(--prim)">your loved one's needs</span>
              </h1>
              <p className="text-gray-700 GolosText w-full md:w-[60%]">
                Find a trusted live-in carer to support your loved one at home,
                day and night, just like Kenn and Nicole did for their parents.
              </p>
