...
import { Eye, HandCoins, HeartPlus, Library } from "lucide-react";
import Stars from "@/components/Stars";
const ReasonPlansData = [
  {
    id: "1",
    plan: "Илүү хэмнэлттэй",
    icon: <HandCoins className="h-6 w-6 text-[#b69974] mb-5" />,
    desc: "Дунджаар, Мэдикс-ийн зуучлалтай үйлчилгээ нь уламжлалт хувилбаруудаас 35%-иар хямд байдаг.",
  },
  {
    id: "2",
    plan: "Илүү хяналттай",
    icon: <Eye className="h-6 w-6 text-[#b69974] mb-5" />,
    desc: "Хэрэв та хүсвэл үйлчилгээний хэмжээг өөрөө тодорхойлоно.",
  },
  {
    id: "3",
    plan: "Илүү сонголттой",
    icon: <Library className="h-6 w-6 text-[#b69974] mb-5" />,
    desc: "Таны сонголтоос хамааран өөрийн хүссэн гэр бүлийн асрагчийг сонгоно.",
  },
  {
    id: "4",
    plan: "Илүү дэмжлэгтэй",
    icon: <HeartPlus className="h-6 w-6 text-[#b69974] mb-5" />,
    desc: "Бидний платформыг ашиглан асран хамгаалалтын тухай төлөвлөж, удирдах боломжтой бөгөөд 5* дээд түвшний дэмжлэгийн багтай чатлах боломжтой.",
  },
];
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="">
              ...
              <h1 className="text-6xl lg:text-6xl CalSans my-5">
                Зөв асран хамгаалагчаа сонгон өөрийн{" "}
                <span className="text-(--prim)">
                  эрхэмлэдэг амьдралын хэв маягаа үргэлжлүүл
                </span>
              </h1>
              <p className="text-gray-700 GolosText w-full md:w-[80%]">
                Бид Улаанбаатар хот, хотын орчимд байрлах гэр бүлүүдийг хувиараа
                хөдөлмөр эрхэлдэг гэрийн асрагч нартай холбодог, зах зээлийн
                платформ юм.
              </p>
        ...
        <div className="flex flex-col lg:flex-row gap-5 h-full mt-10">
          <div className="w-full lg:w-1/1">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {ReasonPlansData.map((plan, index) => (
                <div
                  key={index}
