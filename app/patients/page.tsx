...
const Register = () => {
    ...
    return (
        ...
        //     <div className="className='w-[80%] max-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:items-center">
            ...
            {/* Text content */}
            <div className='bg-stone-800 flex flex-col md:flex-row  gap-48 mt-16 p-t-16 pb-16 pl-16'>
                <div className='p-6 '>
                    {/* Sub heading */}
                    <h1 className='text-[#eeb956] text-lg font-small md:font-medium tracking-widest mb-12'>Энэ өдрийн мэнд 👋</h1>


                    {/* Main heading */}
                    <h1
                        className='text-3xl md:text-5xl font-bold mt-4 mb-8'>Шинээр захиалга үүсгэх
                    </h1>
